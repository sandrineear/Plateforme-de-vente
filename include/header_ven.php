...
<body> 
    <nav role="navigation"  class="navbar navbar-default" style="border:none; ">
		...
		<ul class="nav navbar-nav" style="text-align:center">
			<li><a href="pagevendeur.php"><span class="glyphicon glyphicon-home"></span> HOME </a></li>
			
			<li><a href= "food_v.php"><span class="glyphicon glyphicon-cutlery"></span> Alimentaires </a></li>
			
			<li><a href= "toy_v.php"><span class="glyphicon glyphicon-tower"></span> Jouets </a></li> 
			
			<li><a href= "clothe_v.php"><span class="glyphicon glyphicon-tag"></span> Vêtements </a></li> 
		...
		<form method = "GET" role="search" class="navbar-form navbar-right">
			...
			<a href="listecommande.php"><span class="glyphicon glyphicon-list-alt"></span> Liste des commandes </a>
